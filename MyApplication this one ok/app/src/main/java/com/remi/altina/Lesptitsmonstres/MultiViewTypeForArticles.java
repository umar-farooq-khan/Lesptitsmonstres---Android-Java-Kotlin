        ...
        if (object != null) {
            switch (object.type) {
                case Model.BANNER_TYPE:  //text type
                    ...
                    ((com.remi.altina.Lesptitsmonstres.MultiViewTypeForArticles.TextTypeViewHolder) holder).textView.setMovementMethod(LinkMovementMethod.getInstance());
                       ...
                       // Log.e("preafter split 0", xx[0]);
                        ...
                        if (xx[1].equals("fromnormal")) {
                           // Log.e("prefrom normal", object.data);
                            ...
                            ((com.remi.altina.Lesptitsmonstres.MultiViewTypeForArticles.TextTypeViewHolder) holder).textView.setText(strBuilder);

                            ((com.remi.altina.Lesptitsmonstres.MultiViewTypeForArticles.TextTypeViewHolder) holder).textView.setTypeface(Typeface.SANS_SERIF);
                            ((com.remi.altina.Lesptitsmonstres.MultiViewTypeForArticles.TextTypeViewHolder) holder).textView.setTextSize(progresspref);
                            ...
                            ((com.remi.altina.Lesptitsmonstres.MultiViewTypeForArticles.TextTypeViewHolder) holder).textView.setTypeface(custom_font);
                            ((com.remi.altina.Lesptitsmonstres.MultiViewTypeForArticles.TextTypeViewHolder) holder).textView.setTextSize(progresspref);
